package com.example.sqlshop.adapter;
...
public abstract class BaseRecyclerAdapter extends RecyclerView.Adapter<BaseRecyclerAdapter.BaseViewHolder> {
    ...
    private OnItemClickListener onItemClickListener;//点击事件监听
    private OnItemLongClickListener onItemLongClickListener;//长按事件监听

    @Override
    public BaseViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {//创建holder
